...
SENSORS_GLOBAL = [
    ...
    # Global
    openwbSensorEntityDescription(
        key="counter/set/home_consumption",
        name="Hausverbrauch aktuell (W)",
    ...
    openwbSensorEntityDescription(
        key="counter/set/daily_yield_home_consumption",
        name="Heutiger Hausverbrauch (Wh)",
    ...
    openwbSensorEntityDescription(
        key="chargepoint/get/daily_imported",
    ...
    openwbSensorEntityDescription(
        key="pv/get/daily_exported",
        name="Heutiger PV-Ertrag (Wh)",
        device_class=SensorDeviceClass.ENERGY,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda x: round(float(x), 2),
    ...
    openwbSensorEntityDescription(
        key="counter/0/get/daily_exported",
        name="Heutiger Strom-Export (Wh)",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    openwbSensorEntityDescription(
        key="counter/0/get/daily_imported",
        name="Heutiger Strom-Bezug (Wh)",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    openwbSensorEntityDescription(
        key="bat/get/daily_exported",
        name="Batterieentladung Heute (Wh)",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    openwbSensorEntityDescription(
        key="bat/get/daily_imported",
        name="Batterieladung Heute (Wh)",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        entity_registry_enabled_default=False,
